...
namespace EnglandCheckers.Components
{
    ...
    public class Board
    {
        ...
        public Board(GameDetails i_GameDetailes)
        {
            ...
            r_BordSize = i_GameDetailes.BoardSize;
            r_GameBoard = new BoardCell[r_BordSize, r_BordSize];

            m_GameDetailes = i_GameDetailes;
            r_GameRulesValidator = new GameRulesValidator(this);

            // Set the last column index
            r_LastBoardIndex = r_BordSize - 1;
        ...
        private void fillCoinsOnBoard()
        {
            ...
            int topRowIndexForPlayer1 = (r_BordSize - 1) / 2;

            // Run all overt the rows
            for (int i = 0; i < r_BordSize; i++)
            {
        ...
        private void createBoard()
        {
            ...
            for (int i = 0; i < Size; i++)
            {
                ...
                {
                    r_GameBoard[i, j] = new BoardCell(new BoardPoint(j, i), isCellEnabled);
        ...
        public override string ToString()
        {
            ...
            for (int i = 0; i < r_BordSize; i++)
            {
                ...
                for (int j = 0; j < r_BordSize; j++)
                {
                    Coin currentCoin = r_GameBoard[i, j].Coin;
        ...
        private string getBoardRowsSeperator()
        {
            ...
            int separatorLength = (3 * r_BordSize) + r_LastBoardIndex - 1 + 2 + 2;
        ...
        {
            bool isValidMove = r_GameRulesValidator.IsValidMove(i_Player, i_Move, out o_FailureReason);
        ...
        {
            r_GameBoard[i_Move.To.Row, i_Move.To.Column].Coin = r_GameBoard[i_Move.From.Row, i_Move.From.Column].Coin;
            r_GameBoard[i_Move.From.Row, i_Move.From.Column].Coin = null;
        }
        ...
        public Coin GetCoin(BoardPoint i_Cell)
        {
            ...
            {
                coin = r_GameBoard[i_Cell.Row, i_Cell.Column].Coin;
            }
        ...
        public BoardCell GetBoardCell(BoardPoint i_BoardPoint)
        {
            ...
            {
                boardCell = r_GameBoard[i_BoardPoint.Row, i_BoardPoint.Column];
            }
        ...
        {
            return IsCellExists(i_Cell) && r_GameBoard[i_Cell.Row, i_Cell.Column].IsEmptyCell();
        }
        ...
        {
            return i_BoardPoint.Row >= 0 && i_BoardPoint.Row < r_BordSize && 
                i_BoardPoint.Column >= 0 && i_BoardPoint.Column < r_BordSize;
        }
        ...
        public void RemoveCoin(BoardPoint i_BoardPoint)
        {
            if (IsCellExists(i_BoardPoint))
            {
                r_GameBoard[i_BoardPoint.Row, i_BoardPoint.Column].RemoveCoin();
            }
        }
        ...
        private readonly int r_BordSize;
        private readonly GameRulesValidator r_GameRulesValidator;
    }
}